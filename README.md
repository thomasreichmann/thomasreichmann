Senior full-stack engineer in São Paulo. TypeScript, Next.js, and AWS most days; Java/Kotlin and Spring when the job calls for it. I like owning the parts most people skip past — billing, infra, and the logging that tells you whether any of it actually works.

Right now I'm a senior full-stack engineer at **Skip**, shipping product and reviewing across the team in a private monorepo, which is where most of my recent contributions live. Before that, Cohere Health, and 2.5 years at unike.TECH going from junior to senior on event-driven AWS systems.
